...
RSpec.describe 'App Functional Test' do
  describe 'dollar and percent formats sorted by first_name' do
    ...
    it 'parses input files and sorts by last_name' do
    ...
    it 'parses input files and returns empty array if no input' do
      people_controller = PeopleController.new(
        {
          dollar_format: nil,
          percent_format: nil,
    ...
    it 'parses input files and returns dollar and percent formats unsorted when order is nil' do
      people_controller = PeopleController.new(
        {
          dollar_format: File.read('spec/fixtures/people_by_dollar.txt'),
          percent_format: File.read('spec/fixtures/people_by_percent.txt'),
    ...
    it 'parses input files are return data ordered by birthdate' do
      people_controller = PeopleController.new(
        {
          dollar_format: File.read('spec/fixtures/people_by_dollar.txt'),
          percent_format: File.read('spec/fixtures/people_by_percent.txt'),
